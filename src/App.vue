...
const services = [
  ...
  { number: '06', title: 'Website Undangan Online', text: 'Undangan digital yang personal, praktis, dan memorable untuk momen spesial.', tag: 'SPECIAL MOMENT', image: 'https://images.unsplash.com/photo-1519225421980-715cb0215aed?auto=format&fit=crop&w=1000&q=85' },
...
<template>
  <div class="site-shell">
    <Transition name="loader">
      <div v-if="isLoading" class="page-loader"><img class="loader-logo" src="/logo.jpg" alt="Fintechno Development Solution" /><div class="loader-line"><span></span></div><p>LOADING EXPERIENCE</p></div>
    </Transition>
    <header class="topbar">
      <a class="brand" href="#top" @click.prevent="scrollTo('top')"><img class="brand-logo" src="/logo.jpg" alt="Fintechno Development Solution" /></a>
    ...
    <footer class="footer section-pad"><div><a class="brand" href="#top"><img class="brand-logo" src="/logo.jpg" alt="Fintechno Development Solution" /></a><p>Technology with a point of view.</p></div><div class="footer-meta"><span>YOGYAKARTA · INDONESIA</span><span>© 2024 FDS</span><a href="https://wa.me/6285794909132" target="_blank" rel="noreferrer">WhatsApp ↗</a><a href="https://www.instagram.com/fintechno_/" target="_blank" rel="noreferrer">Instagram ↗</a><a href="https://www.tiktok.com/@fintechno_" target="_blank" rel="noreferrer">TikTok ↗</a></div></footer>
  </div>
</template>
